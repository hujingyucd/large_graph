...
def tile_silhouette_list(solver: BaseSolver, tile_count: int,
                         complete_graph_path,
                         silhouette_list: Union[List[str], str], root_path):
    plotter = Plotter()
    complete_graph = TileGraph(tile_count)
    complete_graph.load_graph_state(complete_graph_path)
...
def tiling_a_region(plotter: Plotter,
    ...
    for idx, solved_layout in enumerate(solutions):
        ...
        result_brick_layout.show_predict(plotter,
                                         os.path.join(
                                             root_path,
                                             f'{score}_{idx}_predict.png'),
        ...
        result_brick_layout.show_predict_prob(
            plotter, os.path.join(root_path, f'{score}_{idx}_prob.png'))
